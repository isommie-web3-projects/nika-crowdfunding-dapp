  ...
  if (showCampaigns) {
    ...
    return (
        <div>
            ...
            <h2 className="text-2xl font-medium text-gray-200 mb-4 animate-bounce duration-2s infinite sm:text-sm flex text-center lg:text-4xl">Welcome to Our Crowdfunding Platform</h2>
